 ...
 ! function(e, t) {
   ...
   return function(e) {
     ...
     (t = e.exports = n(3)(!1)).push([e.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), t.push([e.i, ".conversation-container .header{background-color:#fe207c;color:#fff;display:flex;flex-direction:column;justify-content:center;text-align:center;height:55px;font-family:Roboto,serif;position:relative}.conversation-container .header .avatar{height:31px;width:31px;position:absolute;top:12px;left:14px}.conversation-container .header.with-subtitle{height:70px}.conversation-container .header.with-subtitle .avatar{top:20px}.conversation-container .header.with-subtitle .title{top:11px}.conversation-container .header.with-subtitle span{bottom:12px;position:absolute;left:22px}.conversation-container .header.with-subtitle span.with-avatar{left:60px}.conversation-container .title{font-size:20px;margin:0;font-family:Roboto,serif;position:absolute;left:20px}.conversation-container .title.with-avatar{left:58px}.conversation-container .header-buttons{position:absolute;right:10px;display:flex;flex-direction:row}.conversation-container .close-button{display:none}.conversation-container .toggle-fullscreen-button{display:flex;justify-content:center;align-items:center;display:inline-block;background-color:#fe207c;border:0;width:40px;cursor:pointer}.conversation-container .toggle-fullscreen-button:active,.conversation-container .toggle-fullscreen-button:focus,.conversation-container .toggle-fullscreen-button:hover{outline:none}.conversation-container .toggle-fullscreen-button:active::-moz-focus-inner,.conversation-container .toggle-fullscreen-button:focus::-moz-focus-inner,.conversation-container .toggle-fullscreen-button:hover::-moz-focus-inner{border:0}.conversation-container .toggle-fullscreen{width:30px;height:30px;padding-top:3px}.conversation-container .toggle-fullscreen.default{width:20px;height:20px}.conversation-container .toggle-fullscreen.default:active,.conversation-container .toggle-fullscreen.default:focus,.conversation-container .toggle-fullscreen.default:hover{width:24px;height:24px}.conversation-container .toggle-fullscreen:active,.conversation-container .toggle-fullscreen:focus,.conversation-container .toggle-fullscreen:hover{width:34px;height:34px;top:-2px;margin-left:-2px}.conversation-container .loading{background-color:#b5b5b5;color:#fff;display:flex;flex-direction:column;text-align:center;padding:5px 0;font-family:Roboto,serif;font-size:14px}.widget-embedded .header{display:none}.full-screen .header{border-radius:0;flex-shrink:0;position:relative}.full-screen .close-button,.full-screen .toggle-fullscreen-button{display:flex;justify-content:center;align-items:center;display:inline-block;background-color:#fe207c;border:0;width:40px;cursor:pointer}.full-screen .close-button:active,.full-screen .close-button:focus,.full-screen .close-button:hover,.full-screen .toggle-fullscreen-button:active,.full-screen .toggle-fullscreen-button:focus,.full-screen .toggle-fullscreen-button:hover{outline:none}.full-screen .close-button:active::-moz-focus-inner,.full-screen .close-button:focus::-moz-focus-inner,.full-screen .close-button:hover::-moz-focus-inner,.full-screen .toggle-fullscreen-button:active::-moz-focus-inner,.full-screen .toggle-fullscreen-button:focus::-moz-focus-inner,.full-screen .toggle-fullscreen-button:hover::-moz-focus-inner{border:0}.full-screen .close,.full-screen .toggle-fullscreen{width:30px;height:30px;padding-top:3px}.full-screen .close.default,.full-screen .toggle-fullscreen.default{width:20px;height:20px}.full-screen .close.default:active,.full-screen .close.default:focus,.full-screen .close.default:hover,.full-screen .toggle-fullscreen.default:active,.full-screen .toggle-fullscreen.default:focus,.full-screen .toggle-fullscreen.default:hover{width:24px;height:24px}.full-screen .close:active,.full-screen .close:focus,.full-screen .close:hover,.full-screen .toggle-fullscreen:active,.full-screen .toggle-fullscreen:focus,.full-screen .toggle-fullscreen:hover{width:34px;height:34px;top:-2px;margin-left:-2px}.full-screen .loading{border-radius:0;flex-shrink:0;position:relative}@media screen and (max-width:800px){.conversation-container .header{border-radius:0;flex-shrink:0;position:relative}.conversation-container .close-button{display:flex;justify-content:center;align-items:center;display:inline-block;background-color:#fe207c;border:0;width:40px;cursor:pointer}.conversation-container .close-button:active,.conversation-container .close-button:focus,.conversation-container .close-button:hover{outline:none}.conversation-container .close-button:active::-moz-focus-inner,.conversation-container .close-button:focus::-moz-focus-inner,.conversation-container .close-button:hover::-moz-focus-inner{border:0}.conversation-container .close{width:30px;height:30px;padding-top:3px}.conversation-container .close.default{width:20px;height:20px}.conversation-container .close.default:active,.conversation-container .close.default:focus,.conversation-container .close.default:hover{width:24px;height:24px}.conversation-container .close:active,.conversation-container .close:focus,.conversation-container .close:hover{width:34px;height:34px;top:-2px;margin-left:-2px}.conversation-container .toggle-fullscreen,.conversation-container .toggle-fullscreen-button{display:none}.conversation-container .loading{border-radius:0;flex-shrink:0;position:relative}}", ""])
   }, function(e, t) {
     e.exports = function(e) {
     ...
     (t = e.exports = n(3)(!1)).push([e.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), t.push([e.i, ".conversation-container .message{margin:10px;display:flex;font-size:1em;line-height:1.5;font-family:Roboto,serif}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:#fe207c;color:#fff;border-radius:15px;padding:11px 15px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:0 15px 15px 15px;padding:11px 15px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .message-text .markdown p{margin-bottom:1em}.conversation-container .message-text .markdown p:last-child{margin-bottom:0}", ""])
   }, function(e, t, n) {
     "use strict";
     Object.defineProperty(t, "__esModule", {
       value: !0
